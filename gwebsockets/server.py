# Copyright 2013 Daniel Narvaez, Alex Guzman
#
                ...
                if parsed_message:
                    ...
                    if parsed_message.tp == protocol.OPCODE_TEXT:
                        ...
                        logger.debug("Received binary message, length %s" %
                                     len(received.data))
                    elif parsed_message.tp == protocol.OPCODE_CLOSE:
                        self._send_queue.append((protocol.make_close_message(), None))
...
class Server(GObject.GObject):
    ...
    def start(self):
        ...
        return service.add_inet_port(8000)
...
if __name__ == "__main__":
    ...
    if started:
        print("Listening on port %d", 8000)
